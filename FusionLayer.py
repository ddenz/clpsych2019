...
if __name__ == '__main__':
    ...
    # GloveBiRNN
    grnn_r1 = Bidirectional(SimpleRNN(64, return_sequences=False))(e)
    ...
    glstm_ap = Average()([glstm_do1, glstm_do2])
