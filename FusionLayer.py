...
if __name__ == '__main__':
    ...
    gcnn_out = Dense(4, activation='softmax')(gcnn_do1)
    gcnn_mp = MaxPooling1D()(gcnn_out)
    gcnn_ap = AveragePooling1D()(gcnn_out)
    gcnn_att = Attention(gcnn_out)
    ...
    grnn_out = Dense(4, activation='softmax')(grnn_do2)
    grnn_mp = MaxPooling1D()(grnn_out)
    grnn_ap = AveragePooling1D()(grnn_out)
    grnn_att = Attention(grnn_out)
    ...
    ggru_out = Dense(4, activation='softmax')(ggru_do2)
    ggru_mp = MaxPooling1D()(ggru_out)
    ggru_ap = AveragePooling1D()(ggru_out)
    ggru_att = Attention(ggru_out)
    ...
    glstm_out = Dense(4, activation='softmax')(glstm_do2)
    glstm_mp = MaxPooling1D()(glstm_out)
    glstm_ap = AveragePooling1D()(glstm_out)
    glstm_att = Attention(glstm_out)
